...
# 1 "../../../submodule/c-library/struct.h" 1
# 10 "../../../submodule/c-library/struct.h"
...
typedef struct _bytes32 bytes32_t; typedef bytes32_t *bytes32_p; struct _bytes32
{
    uint v[8];
};
...
void bytes32_convert(bytes32_t res, luint value_int);
void bytes32_add_uint(bytes32_t res, uint value, int i);
void bytes32_add(bytes32_t res, bytes32_t value1, bytes32_t value2);
void bytes32_mul(bytes32_t res, bytes32_t value1, bytes32_t value2);
# 6 "../code.c" 2
...
void test_convert()
{
    ...
    luint u = 0x100000002;
    bytes32_t res = bytes32_convert(u);
    printf("\n%s: ", "res here: ");bytes32_display(res);printf("\n");
    { bytes32_t expected; bytes32_set(expected, 0, 0, 0, 0, 0, 0, 1, 2 ); 
# 38 "test.c" 3 4
   ((void) sizeof ((
# 38 "test.c"
   memcmp(res.v, expected.v, 32) == 0
# 38 "test.c" 3 4
...
# 38 "test.c"
   "memcmp(res.v, expected.v, 32) == 0"
# 38 "test.c" 3 4
   , "test.c", 38, __extension__ __PRETTY_FUNCTION__); }))
# 38 "test.c"
   ; };
}
